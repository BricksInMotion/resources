...
this.parent(A);var D=this.cancel.bind(this,false);if($type(this.element)!="element"){this.element=$(getDocument().body);}var C=this.element;
...
// As of June 11, 2009, added Request.JSON and Request.Periodical, specifically for the chat - Jason
