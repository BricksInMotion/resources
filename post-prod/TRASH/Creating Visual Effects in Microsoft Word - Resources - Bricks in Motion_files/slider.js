...
function moveSlider(evnt)
{
	...
	if (carpemouseover) { // Only if slider is dragged
		...
		var textWarn = document.getElementById("warn_"+carpedisplay.id);
		//alert(textWarn);
		switch(v) {
			case 0:
				textWarn.innerHTML="<b style='color:#b4cfdd;'>NONE</b>";
				break;
			case 1:
				textWarn.innerHTML="<b style='color:green;'>MILD</b>";
				break;
			case 2:
				textWarn.innerHTML="<b style='color:orange;'>MODERATE</b>";
				break;
			case 3:
				textWarn.innerHTML="<b style='color:red;'>STRONG</b>";
				break;
			default:
				textWarn.innerHTML="";
		}
		//alert(carpedisplay.value);
		return false;
	}
	return
}
